...
export const markupIdSchema = entityIdSchema.brand<"MarkupId">();
export const findingIdSchema = entityIdSchema.brand<"FindingId">();
export const savedViewIdSchema = entityIdSchema.brand<"SavedViewId">();
export const figureIdSchema = entityIdSchema.brand<"FigureId">();
export const reportIdSchema = entityIdSchema.brand<"ReportId">();
...
export type MarkupId = z.infer<typeof markupIdSchema>;
